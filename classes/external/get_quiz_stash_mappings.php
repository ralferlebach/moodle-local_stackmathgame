...
/**
 * External function: get_quiz_stash_mappings.
 *
...
/**
 * Legacy quiz wrapper for activity-based stash mapping reads.
 *
 * @package    local_stackmathgame
 * @copyright  2026 Ralf Erlebach
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class get_quiz_stash_mappings extends \external_api {
    /**
    ...
    public static function execute(int $quizid): array {
        ...
        $result = get_activity_stash_mappings::execute(
            (int)$activity['cmid'],
