...
/**
 * External function: save_activity_stash_mappings.
 *
...
/**
 * Persist activity-oriented stash mappings for settings UIs.
 *
 * @package    local_stackmathgame
 * @copyright  2026 Ralf Erlebach
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class save_activity_stash_mappings extends \external_api {
    /**
     ...
     * @return array The persisted stash mapping export.
     */
    public static function execute(int $cmid, string $modname = 'quiz', int $instanceid = 0, array $mappings = []): array {
        [$cm, , , , , $activity] = api::validate_activity_configuration_access($cmid, $modname, $instanceid);
