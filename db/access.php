...
$capabilities = [
    ...
    'local/stackmathgame:selectdesign' => [
        'captype' => 'write',
        'contextlevel' => CONTEXT_MODULE,
        'archetypes' => [
            'editingteacher' => CAP_ALLOW,
    ...
    'local/stackmathgame:viewstudio' => [
        'captype' => 'read',
    ...
    'local/stackmathgame:managenarratives' => [
        'captype' => 'write',
        'contextlevel' => CONTEXT_SYSTEM,
        'archetypes' => [
            'manager' => CAP_ALLOW,
    ...
    'local/stackmathgame:manageassets' => [
        'captype' => 'write',
        'contextlevel' => CONTEXT_SYSTEM,
        'archetypes' => [
            'manager' => CAP_ALLOW,
    ...
    'local/stackmathgame:managemechanics' => [
        'captype' => 'write',
        'contextlevel' => CONTEXT_SYSTEM,
        'archetypes' => [
            'manager' => CAP_ALLOW,
