...
$string['designnarrative'] = 'Narrative';
$string['designnarrative_hint'] = 'One line per entry. Leave a scene empty to fall back to the game mode\'s own wording.';
$string['designnarrativejson'] = 'Narrative (JSON)';
$string['designpresentation'] = 'Presentation';
$string['designraw'] = 'Advanced: raw configuration';
$string['designraw_hint'] = 'These show what the settings above currently amount to. If you edit one, your edit wins for that field and the settings above are ignored for it. Fields you leave untouched are rebuilt from the settings.';
$string['designscene_boss_clear'] = 'After beating a boss';
$string['designscene_boss_intro'] = 'A boss appears';
$string['designscene_chapter_start'] = 'Starting a chapter';
$string['designscene_defeat'] = 'After a wrong answer';
$string['designscene_outro'] = 'At the end of the run';
$string['designscene_reward'] = 'On a reward';
$string['designscene_transition'] = 'Between scenes';
$string['designscene_victory'] = 'After a correct answer';
$string['designscene_world_enter'] = 'Entering the world';
...
$string['designuitheme'] = 'Visual theme';
...
$string['err_slotnotoffered'] = 'Question {$a} is not one of the questions offered to you on this page.';
$string['err_unknownslot'] = 'Slot {$a} is not part of this attempt.';
...
$string['flow_badge_deadend'] = 'Dead end';
$string['flow_badge_unreachable'] = 'Unreachable';
$string['flow_branching'] = 'Branching';
$string['flow_branchmode_end'] = 'Finish the run';
$string['flow_branchmode_linear'] = 'Next slot in order';
$string['flow_branchmode_slot'] = 'Jump to a slot';
$string['flow_branchtarget'] = 'Target slot';
$string['flow_branchtarget_for'] = 'Target slot ({$a})';
$string['flow_branchtarget_none'] = '(none)';
$string['flow_branchto'] = 'Jump to slot {$a}';
$string['flow_bulk'] = 'Apply to selected slots';
$string['flow_bulk_applied'] = 'Applied to {$a} slot(s).';
$string['flow_bulk_apply'] = 'Apply';
$string['flow_bulk_desc'] = 'Only the fields you fill in are applied. Everything else on the selected scenes is left as it is.';
$string['flow_bulk_failed'] = 'Could not save these slots: {$a}';
$string['flow_bulk_nochange'] = '(leave unchanged)';
$string['flow_bulk_noselection'] = 'No slots were selected.';
$string['flow_bulk_nothing'] = 'Nothing to apply: fill in at least one field.';
$string['flow_col_actions'] = 'Actions';
$string['flow_col_branch'] = 'After a correct answer';
$string['flow_col_question'] = 'Question';
$string['flow_col_rewards'] = 'Score / XP';
$string['flow_col_scene'] = 'Scene';
$string['flow_col_slot'] = 'Slot';
$string['flow_crowdedpages'] = 'Pages holding more than one question (only the first is played)';
$string['flow_deadends'] = 'No path leaves these slots';
$string['flow_display'] = 'Display options';
$string['flow_display_showavatar'] = 'Show avatar';
$string['flow_display_showinventory'] = 'Show inventory';
$string['flow_display_showxp'] = 'Show XP';
$string['flow_edit'] = 'Edit';
$string['flow_err_negativereward'] = 'A reward cannot be negative.';
$string['flow_err_targetrequired'] = 'Choose a target slot for the jump.';
...
$string['flow_group'] = 'Questions sharing this page';
$string['flow_group_hint'] = 'This quiz page holds several questions: slots {$a}. Decide what they are to the game. This setting belongs to the page and is edited here, on its first question.';
$string['flow_groupmode'] = 'Use them as';
$string['flow_groupmode_alternatives'] = 'Alternatives (play a subset)';
$string['flow_groupmode_help'] = 'Separate scenes plays each question in turn as its own scene, which is what the game did before this setting existed. Alternatives treats them as interchangeable and plays a subset. A staged quest plays them all in order as parts of one task.';
$string['flow_groupmode_quest'] = 'Staged quest (play all in order)';
$string['flow_groupmode_scenes'] = 'Separate scenes';
$string['flow_grouppick'] = 'How many to play';
$string['flow_groupstrategy'] = 'Which ones';
...
$string['flow_narrative_intro'] = 'Shown when the scene opens';
$string['flow_narrative_success'] = 'Shown after a correct answer';
$string['flow_nonstack'] = 'Not STACK';
$string['flow_noslots'] = 'This quiz has no questions yet. Add questions first, then come back to lay out the flow.';
$string['flow_outcome_complete'] = 'When the scene is complete';
$string['flow_outcome_default'] = 'Otherwise';
$string['flow_outcome_gradedright'] = 'After a correct answer';
$string['flow_outcome_gradedwrong'] = 'After a wrong answer';
$string['flow_page'] = 'Page';
$string['flow_pick_first'] = 'The first ones, in quiz order';
$string['flow_pick_random'] = 'At random, fixed for each attempt';
$string['flow_problems'] = 'The flow has problems a single scene cannot show on its own.';
$string['flow_reward_achievements'] = 'Achievement keys';
$string['flow_reward_achievements_help'] = 'A comma-separated list of keys. Each is granted once, the first time this scene is solved.';
$string['flow_reward_score'] = 'Score';
$string['flow_reward_xp'] = 'XP';
$string['flow_rewards'] = 'Rewards';
$string['flow_scene'] = 'Scene';
$string['flow_scenetype'] = 'Scene type';
$string['flow_scenetype_boss'] = 'Boss';
$string['flow_scenetype_challenge'] = 'Challenge';
$string['flow_scenetype_help'] = 'What role this question plays in the story. The scene type is advisory: game modes may treat a boss differently from a challenge, but every type is answered the same way.';
$string['flow_scenetype_instruction'] = 'Instruction';
$string['flow_scenetype_miniboss'] = 'Mini-boss';
$string['flow_scenetype_outro'] = 'Outro';
$string['flow_scenetype_reward'] = 'Reward';
$string['flow_scenetype_transition'] = 'Transition';
$string['flow_select'] = 'Select';
$string['flow_sharespage'] = 'Shares a page';
$string['flow_slotenabled'] = 'Scene active';
$string['flow_slotheading'] = 'Slot {$a->slot}: {$a->question}';
$string['flow_sync'] = 'Resynchronise with the quiz';
$string['flow_synced'] = 'Flow resynchronised: {$a->created} added, {$a->updated} updated, {$a->deleted} removed. Existing scene configuration was kept.';
$string['flow_unreachable'] = 'No path reaches these slots';
$string['flow_untitled'] = '(untitled question)';
...
$string['prereq_archetypal'] = 'Behaviour is selectable';
$string['prereq_archetypal_missing'] = 'qbehaviour_stackmathgame does not declare itself archetypal, so Moodle leaves it out of the quiz question behaviour menu and refuses to start an attempt with it. Its behaviourtype.php needs an is_archetypal() method returning true.';
$string['prereq_archetypal_ok'] = 'The behaviour can be chosen as a quiz question behaviour.';
$string['prereq_archetypal_skipped'] = 'Not checked: the behaviour plugin is not installed.';
...
$string['prereq_perpage'] = 'One question per page';
$string['prereq_perpage_crowded'] = 'These pages hold more than one question: {$a}. The game navigates between pages, so it plays the first question on each and skips the rest. Move them onto pages of their own, or leave them for players to reach through the ordinary quiz navigation.';
$string['prereq_perpage_ok'] = 'Every page holds a single question, which is what the branching navigation expects.';
$string['prereq_perpage_unknown'] = 'Not checked: the quiz structure could not be read.';
...
$string['submitanswerbusy'] = 'Another submission for this scene is still being processed. Please try again in a moment.';
