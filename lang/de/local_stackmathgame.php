...
$string['designnarrative'] = 'Narrativ';
$string['designnarrative_hint'] = 'Eine Zeile je Eintrag. Eine leere Szene fällt auf den eigenen Text des Spielmodus zurück.';
$string['designnarrativejson'] = 'Narrativ (JSON)';
$string['designpresentation'] = 'Darstellung';
$string['designraw'] = 'Erweitert: Rohkonfiguration';
$string['designraw_hint'] = 'Hier steht, was die Einstellungen oben derzeit ergeben. Wenn Sie eines dieser Felder bearbeiten, hat Ihre Änderung für dieses Feld Vorrang und die Einstellungen oben werden dafür ignoriert. Unveränderte Felder werden aus den Einstellungen neu erzeugt.';
$string['designscene_boss_clear'] = 'Nach besiegtem Endgegner';
$string['designscene_boss_intro'] = 'Ein Endgegner erscheint';
$string['designscene_chapter_start'] = 'Beginn eines Kapitels';
$string['designscene_defeat'] = 'Nach falscher Antwort';
$string['designscene_outro'] = 'Am Ende des Durchlaufs';
$string['designscene_reward'] = 'Bei einer Belohnung';
$string['designscene_transition'] = 'Zwischen Szenen';
$string['designscene_victory'] = 'Nach richtiger Antwort';
$string['designscene_world_enter'] = 'Betreten der Welt';
...
$string['designuitheme'] = 'Visuelles Thema';
...
$string['err_slotnotoffered'] = 'Frage {$a} gehört nicht zu den Fragen, die Ihnen auf dieser Seite angeboten werden.';
$string['err_unknownslot'] = 'Platz {$a} gehört nicht zu diesem Versuch.';
...
$string['flow_badge_deadend'] = 'Sackgasse';
$string['flow_badge_unreachable'] = 'Unerreichbar';
$string['flow_branching'] = 'Verzweigung';
$string['flow_branchmode_end'] = 'Durchlauf beenden';
$string['flow_branchmode_linear'] = 'Nächster Frageplatz der Reihe nach';
$string['flow_branchmode_slot'] = 'Zu einem Frageplatz springen';
$string['flow_branchtarget'] = 'Zielplatz';
$string['flow_branchtarget_for'] = 'Zielplatz ({$a})';
$string['flow_branchtarget_none'] = '(keiner)';
$string['flow_branchto'] = 'Sprung zu Platz {$a}';
$string['flow_bulk'] = 'Auf ausgewählte Plätze anwenden';
$string['flow_bulk_applied'] = 'Auf {$a} Platz/Plätze angewendet.';
$string['flow_bulk_apply'] = 'Anwenden';
$string['flow_bulk_desc'] = 'Angewendet wird nur, was Sie ausfüllen. Alles Übrige der ausgewählten Szenen bleibt unverändert.';
$string['flow_bulk_failed'] = 'Diese Plätze konnten nicht gespeichert werden: {$a}';
$string['flow_bulk_nochange'] = '(unverändert lassen)';
$string['flow_bulk_noselection'] = 'Es wurden keine Plätze ausgewählt.';
$string['flow_bulk_nothing'] = 'Nichts anzuwenden: bitte mindestens ein Feld ausfüllen.';
$string['flow_col_actions'] = 'Aktionen';
$string['flow_col_branch'] = 'Nach richtiger Antwort';
$string['flow_col_question'] = 'Frage';
$string['flow_col_rewards'] = 'Punkte / XP';
$string['flow_col_scene'] = 'Szene';
$string['flow_col_slot'] = 'Platz';
$string['flow_crowdedpages'] = 'Seiten mit mehr als einer Frage (nur die erste wird gespielt)';
$string['flow_deadends'] = 'Von diesen Plätzen führt kein Pfad weiter';
$string['flow_display'] = 'Anzeigeoptionen';
$string['flow_display_showavatar'] = 'Avatar anzeigen';
$string['flow_display_showinventory'] = 'Inventar anzeigen';
$string['flow_display_showxp'] = 'XP anzeigen';
$string['flow_edit'] = 'Bearbeiten';
$string['flow_err_negativereward'] = 'Eine Belohnung kann nicht negativ sein.';
$string['flow_err_targetrequired'] = 'Bitte einen Zielplatz für den Sprung wählen.';
...
$string['flow_group'] = 'Fragen auf dieser Seite';
$string['flow_group_hint'] = 'Diese Testseite enthält mehrere Fragen: Plätze {$a}. Legen Sie fest, was sie für das Spiel bedeuten. Diese Einstellung gehört zur Seite und wird hier, an ihrer ersten Frage, bearbeitet.';
$string['flow_groupmode'] = 'Verwenden als';
$string['flow_groupmode_alternatives'] = 'Alternativfragen (Auswahl spielen)';
$string['flow_groupmode_help'] = 'Einzelne Szenen spielt jede Frage nacheinander als eigene Szene — so verhielt sich das Spiel, bevor es diese Einstellung gab. Alternativfragen behandelt sie als austauschbar und spielt eine Auswahl. Eine gestufte Quest spielt alle der Reihe nach als Teile einer Aufgabe.';
$string['flow_groupmode_quest'] = 'Gestufte Quest (alle der Reihe nach)';
$string['flow_groupmode_scenes'] = 'Einzelne Szenen';
$string['flow_grouppick'] = 'Wie viele spielen';
$string['flow_groupstrategy'] = 'Welche';
...
$string['flow_level'] = 'Level';
$string['flow_narrative'] = 'Narrativ';
$string['flow_narrative_fail'] = 'Wird nach einer falschen Antwort gezeigt';
$string['flow_narrative_intro'] = 'Wird beim Betreten der Szene gezeigt';
$string['flow_narrative_success'] = 'Wird nach einer richtigen Antwort gezeigt';
$string['flow_nonstack'] = 'Kein STACK';
$string['flow_noslots'] = 'Dieser Test enthält noch keine Fragen. Bitte zuerst Fragen hinzufügen, dann den Ablauf gestalten.';
$string['flow_outcome_complete'] = 'Wenn die Szene abgeschlossen ist';
$string['flow_outcome_default'] = 'Ansonsten';
$string['flow_outcome_gradedright'] = 'Nach richtiger Antwort';
$string['flow_outcome_gradedwrong'] = 'Nach falscher Antwort';
$string['flow_page'] = 'Seite';
$string['flow_pick_first'] = 'Die ersten, in Testreihenfolge';
$string['flow_pick_random'] = 'Zufällig, je Versuch festgelegt';
$string['flow_problems'] = 'Der Ablauf hat Probleme, die eine einzelne Szene für sich nicht zeigen kann.';
$string['flow_reward_achievements'] = 'Achievement-Schlüssel';
$string['flow_reward_achievements_help'] = 'Kommagetrennte Liste. Jeder Schlüssel wird einmal vergeben, beim ersten Lösen dieser Szene.';
$string['flow_reward_score'] = 'Punkte';
$string['flow_reward_xp'] = 'XP';
$string['flow_rewards'] = 'Belohnungen';
$string['flow_scene'] = 'Szene';
$string['flow_scenetype'] = 'Szenentyp';
$string['flow_scenetype_boss'] = 'Endgegner';
$string['flow_scenetype_challenge'] = 'Aufgabe';
$string['flow_scenetype_help'] = 'Welche Rolle diese Frage in der Geschichte spielt. Der Szenentyp ist ein Hinweis: Spielmodi dürfen einen Endgegner anders behandeln als eine gewöhnliche Aufgabe, beantwortet werden aber alle Typen gleich.';
$string['flow_scenetype_instruction'] = 'Anleitung';
$string['flow_scenetype_miniboss'] = 'Zwischengegner';
$string['flow_scenetype_outro'] = 'Abspann';
$string['flow_scenetype_reward'] = 'Belohnung';
$string['flow_scenetype_transition'] = 'Übergang';
$string['flow_select'] = 'Auswählen';
$string['flow_sharespage'] = 'Teilt sich eine Seite';
$string['flow_slotenabled'] = 'Szene aktiv';
$string['flow_slotheading'] = 'Platz {$a->slot}: {$a->question}';
$string['flow_sync'] = 'Mit dem Test abgleichen';
$string['flow_synced'] = 'Ablauf abgeglichen: {$a->created} neu, {$a->updated} aktualisiert, {$a->deleted} entfernt. Vorhandene Szenenkonfiguration blieb erhalten.';
$string['flow_unreachable'] = 'Diese Plätze werden von keinem Pfad erreicht';
$string['flow_untitled'] = '(Frage ohne Titel)';
...
$string['prereq_archetypal'] = 'Verhalten ist auswählbar';
$string['prereq_archetypal_missing'] = 'qbehaviour_stackmathgame deklariert sich nicht als archetypal. Moodle blendet es deshalb aus der Auswahl „Frageverhalten" aus und verweigert den Start eines Versuchs damit. In dessen behaviourtype.php fehlt eine Methode is_archetypal(), die true liefert.';
$string['prereq_archetypal_ok'] = 'Das Frageverhalten kann in einem Test ausgewählt werden.';
$string['prereq_archetypal_skipped'] = 'Nicht geprüft: das Verhaltens-Plugin ist nicht installiert.';
...
$string['prereq_perpage'] = 'Eine Frage pro Seite';
$string['prereq_perpage_crowded'] = 'Diese Seiten enthalten mehr als eine Frage: {$a}. Das Spiel navigiert zwischen Seiten und spielt deshalb je Seite nur die erste Frage; die übrigen werden übersprungen. Bitte auf eigene Seiten verschieben — oder so belassen, dann sind sie über die normale Testnavigation erreichbar.';
$string['prereq_perpage_ok'] = 'Jede Seite enthält genau eine Frage — so erwartet es die Verzweigungsnavigation.';
$string['prereq_perpage_unknown'] = 'Nicht geprüft: die Teststruktur konnte nicht gelesen werden.';
...
$string['submitanswerbusy'] = 'Für diese Szene wird gerade eine andere Antwort verarbeitet. Bitte gleich noch einmal versuchen.';
